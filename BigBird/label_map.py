...
# winograd
WinogradLabelMapper = Vocabulary(True)
WinogradLabelMapper.add('contradiction')
WinogradLabelMapper.add('entailment')

# copa
COPALabelMapper = Vocabulary(True)
COPALabelMapper.add('implausible')
COPALabelMapper.add('plausible')
...
GLOBAL_MAP = {
 ...
 'winograd': WinogradLabelMapper,
 'copa': COPALabelMapper,
}
